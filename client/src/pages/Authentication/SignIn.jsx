...
const SignIn= () => {
  ...
  const {user,loginInput, loginFunction, loginData, loginError, loginLoading} = useContext(AuthContext);
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={loginFunction}>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value={loginLoading ? "Loading" : loginError ? loginError : "Sign-in"}
                    className={`w-full cursor-pointer rounded-lg border border-primary  text-white transition hover:bg-opacity-90 p-4 ${loginError ? "bg-red-700" : "bg-primary"}`}
                  />
                </div>
