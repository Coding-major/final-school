            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {user && user.role === "business" ?
                <li>
                  <NavLink
                    to="/my-products"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('my-products') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
...

              {
                user && user.role === "business" ?
                  <li>
                    <NavLink
                      to="/create-product"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("create-product") && "bg-graydark dark:bg-meta-4"
                        }`}
                    >
                      <svg
                        className="fill-current"
                      ...
                      >
                        ...
                        />
                        <path
                          d="M13 11h4v2h-4v4h-2v-4H7v-2h4V7h2v4z"
                          fill="currentColor"
                        />
                      </svg>
                      Create Product
...

              {
                user && user.role === "customer" ?
                  <li>
                    <NavLink
                      to="/cart"
                      className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes("cart") && "bg-graydark dark:bg-meta-4"
                        }`}
                    >
                      <svg
                        className="fill-current"
                      ...
                      >
                        <path
                          d="M3 3H5L6.68 14.39C6.79 15.27 7.53 15.93 8.42 15.93H17.65C18.54 15.93 19.28 15.27 19.39 14.39L21 6H6"
                          stroke="currentColor"
                          strokeWidth="2"
                          strokeLinecap="round"
